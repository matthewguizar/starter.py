...
colors = ['dark gray', 'light gray', 'medium gray', 'extra-medium gray', 'blue' ]
# print(colors)
...
# even_numbers = []
# for even_nums in numbers:
#     if even_nums % 2 == 0:
#         even_numbers.append(even_nums)
# print(even_numbers)
